...
function eventType() {
  ...
  var eventSource = firstEvent.eventSource;

  return eventSource === 'aws:sqs' ? type : false;
}

var keys = ['receiptHandle', 'md5OfBody', 'eventSourceARN', 'awsRegion', 'messageId', 'attributes.ApproximateFirstReceiveTimestamp', 'attributes.SenderId', 'attributes.ApproximateReceiveCount', 'attributes.SentTimestamp'].map(function (str) {
